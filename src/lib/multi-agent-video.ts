...
export function buildVideoAgentGraph(instruction: string): AgentTask[] {
  return [
    ...
    { role: "editor", objective: "Translate approved shot plans into a layer-aware reversible timeline plan.", inputs: ["storyboard", "current timeline", "user revision"], output: "timeline edit plan", preferredModel: AGENT_ROLES.editor.model },
